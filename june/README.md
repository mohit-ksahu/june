# June Architecture & Specification
...
```
- These operations represent a full line-by-line comparison of the entire file. Downstream client presentation layers can format or filter this list as needed.
...
* **Role**: Runs Myers diagonal searches and maps edit history coordinates to compute full line-by-line differences.
